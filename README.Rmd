...
[![Codecov test coverage](https://codecov.io/gh/matt-dray/soccercolleagues/branch/main/graph/badge.svg)](https://codecov.io/gh/matt-dray/soccercolleagues?branch=main)
[![Blog
...
Read more in [the accompanying blog post](https://www.rostrum.blog/2022/02/04/soccercolleagues/).
...
You can install the package from GitHub. It uses the base R pipe (`|>`) internally, so you'll need R >=v4.1.
